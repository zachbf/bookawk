				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-6">
								<a href="<?php echo base_url();?>auth/register" id="register-form-link">Register</a>
							</div>
						</div>
						<hr>
					</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="<?php echo base_url();?>login/recover" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
